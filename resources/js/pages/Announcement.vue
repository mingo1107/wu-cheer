          ...
          <form @submit.prevent="submit" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="md:col-span-2">
                <label class="label-base">標題 *</label>
              ...
              <div>
                <label class="label-base">開始時間</label>
                <input v-model="form.starts_at" type="datetime-local" lang="en-GB" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent" />
              </div>

              <div>
                <label class="label-base">結束時間</label>
                <input v-model="form.ends_at" type="datetime-local" lang="en-GB" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent" />
              </div>

              <div class="md:col-span-2">
                <label class="label-base">啟用狀態</label>
              ...
              <div class="md:col-span-2">
                <label class="label-base">公告內文</label>
